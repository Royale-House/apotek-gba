						...
						<header>
							...
							<div class="widget-body">
								...
								<form class="form-horizontal">
									...
									<fieldset>
										<legend>Form Inputan Data Gudang</legend>
						...
						<div>
							...
							<div class="widget-body no-padding">
						        ...
						        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
									<thead>			                
										<tr>
											<th data-hide="phone">Kode Gudang</th>
											<th data-class="expand"><i class="fa fa-fw fa-user text-muted hidden-md hidden-sm hidden-xs"></i>Nama</th>
											<th data-hide="phone"><i class="fa fa-fw fa-map-marker txt-color-blue hidden-md hidden-sm hidden-xs"></i> </i> Alamat</th>
											<th data-hide="phone,tablet"><i class="fa fa-fw fa-map-marker txt-color-blue hidden-md hidden-sm hidden-xs"></i> Kota</th>
											<th data-hide="phone,tablet"><i class="fa fa-fw fa-phone text-muted hidden-md hidden-sm hidden-xs"></i>Telepon</th>
