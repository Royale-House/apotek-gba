						...
						<header>
							...
							<div class="widget-body">
								...
								<form class="form-horizontal">
									...
									<fieldset>
										<legend>Form Inputan Data Obat</legend>
						        ...
						        <table id="dt_basic" class="table table-striped table-bordered table-hover" width="100%">
									<thead>			                
										<tr>
											...
											<th data-class="expand">Nama Obat</th>
											<th data-hide="phone">Suplier</th>
											<th data-hide="phone,tablet">Golongan</th>
											<th data-hide="phone,tablet">>Kategori</th>
											<th data-hide="phone,tablet">Kandungan</th>
											<th data-hide="phone,tablet">Lokasi Etalase</th>
									...
									<tbody>
										<tr>
											...
											<td></td>
											<td></td>
											<td><button class="btn btn-xs btn-default" data-original-title="Edit Row" onclick="jQuery('#jqgrid').editRow('1');"><i class="fa fa-eye"></i></button>
											<button class="btn btn-xs btn-default" data-original-title="Edit Row" onclick="jQuery('#jqgrid').editRow('1');"><i class="fa fa-pencil"></i></button>
